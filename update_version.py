...
def main():
  ...
  plistpath = scriptpath + "/resources/StreamMaster-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StreamMaster-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StreamMaster-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StreamMaster-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StreamMaster-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StreamMaster-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/StreamMaster-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/StreamMaster.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/StreamMaster.iss",inplace=1):
