...
const IColor PLUG_TP_LABEL_OK_COLOR(255, 64, 220, 64);
const IColor PLUG_TP_LABEL_ALERT_COLOR(255, 255, 64, 64);
const IColor PLUG_TP_LABEL_RESET_COLOR(255, 128, 128, 128);

const IColor PLUG_DR_LABEL_OK_COLOR(255, 64, 220, 64);
const IColor PLUG_DR_LABEL_WARNING_COLOR(255, 255, 255, 32);
const IColor PLUG_DR_LABEL_RESET_COLOR(255, 128, 128, 128);
...
// Knob gearing (speed)
#define PLUG_PEAKING_KNOB_GEARING 2.
#define PLUG_PLATFORM_SELECTOR_GEARING 1.2
#define PLUG_ADJUST_KNOB_GEARING 1.8

// GR meter filter
#define PLUG_GR_METER_ATTACK 1.
#define PLUG_GR_METER_DECAY 0.002
